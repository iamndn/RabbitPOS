            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="flex justify-end pt-1">
                <button
                  type="submit"
                  disabled={submitting}
                  className="px-4 py-2 text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 rounded-xl shadow-sm flex items-center space-x-1.5 transition"
                >
                  {isEditing ? (
                    <>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <div className="flex items-center space-x-1 bg-slate-100 p-1 rounded-xl">
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-xs font-semibold transition ${activeFilter === 'all'
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-xs font-semibold transition ${activeFilter === 'outflow'
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-xs font-semibold transition ${activeFilter === 'inflow'
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="flex items-center space-x-2">
                          ...
                          {cat.is_system && (
                            <span className="inline-flex items-center space-x-1 px-1.5 py-0.5 rounded text-[9px] font-bold bg-amber-50 text-amber-600 border border-amber-200">
                              <ShieldCheck className="w-3 h-3" />
                              <span>{t('tx_cat.system_default') || 'Mặc định'}</span>
                            </span>
                          )}
                        </div>
